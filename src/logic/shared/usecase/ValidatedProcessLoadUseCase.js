/**
 * @file ValidatedProcessLoadUseCase.js
 * @description Template Class of validated process and load Use Case
 */
...
export default class ValidatedProcessLoadUseCase extends IUseCase {
    #inspector;
    #processor;
    #transporter;
